...
var Suite = api_1.Api.Suite;
var Test = api_1.Api.Test;
...
// AddListener({
//     onStart: result => console.log('on start', JSON.stringify(result)),
//     onSuiteStart: result => console.log('on suite start', JSON.stringify(result)),
//     onTestStart: result => console.log('on test start', JSON.stringify(result)),
//     onTestFinish: result => console.log('on test finish', JSON.stringify(result)),
//     onSuiteFinish: result => console.log('on suite finish', JSON.stringify(result)),
//     onFinish: result => console.log('on finish', JSON.stringify(result))
// })
// TODO test everything
// just tests, no suites required :)
Test('my test 1', () => sleepWithMessage('test1'));
Test('my test 2', () => sleepWithMessageAndError('test2'));
...
Suite('my first suite', () => {
    ...
    Test('my test 12', () => sleepWithMessageAndError('test12'));
